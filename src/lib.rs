...
#[derive(Debug)]
pub struct SmartChatProcessor {
    verbose: bool,
    processed_count: usize,
}

impl SmartChatProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting SmartChat processing");
    
    let mut processor = SmartChatProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = SmartChatProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = SmartChatProcessor::new(false);
